...
int thirdBoard[12][12] = //Used to test if a position is valid
{
	7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,
	7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,
	7,  7,  2,  3,  4,  5,  6,  4,  3,  2,  7,  7,
...
void CopyingMainToThird()
{
	for (int i = 0; i < 12; i++)
	{
		for (int j = 0; j < 12; j++)
		{
			board[i][j] = thirdBoard[i][j];
		}
	}
}
void CopyingThirdToMain()
{
	for (int i = 0; i < 12; i++)
	{
		for (int j = 0; j < 12; j++)
...
int countGames(int numPly, string recurFEN, string origFen)
{
	int count = 0;
	if(turn == 0)
	{
		vector<string> movesVector = parseMoves(AllMovesW(recurFEN));
		turn = 1;
	}
	else if(turn == 1)
	{
		vector<string> movesVector = parseMoves(AllMovesB(recurFEN));
		turn = 0;
	}
	return 1;
}
